  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center gap-3 border-b border-line-soft bg-surface/90 px-4 backdrop-blur sm:px-6">
      ...
      <div className="ml-auto flex items-center gap-2 sm:gap-3">
        ...
        <button aria-label="Notifications" className="relative rounded-lg p-2 text-ink-700 hover:bg-surface-alt">
          <Bell size={20} />
        ...
        <Dropdown
          ...
          items={[
            ...
            { divider: true },
            { label: 'Log out', icon: LogOut, danger: true, onClick: () => navigate('/login') },
          ]}
        />
      </div>
    </header>
